//My version of Fun4All_G4_Tracking.C
...
void Fun4All_G4_Tracking(int nEvents = 1)
{
  // The fun4all Server;                                                                                                                              
...
***                                                                                                                                                   
 ...
 se->registerSubsystem(kalman);
        ...
        for (int i = 10; i < 10+_NO_OF_BARREL_LAYERS_; i++) { // hits in the  MimosaCore volumes                                                      
          std::string nodeName = "SVT_" + std::to_string(i); // ****** THIS NEEDS TO MATCH WHAT'S INPUT IN GdmlImportDetector.cc, stripped of the G4H\
IT, because currently SimpleNtuple adds that.                                                                                                         
          // See SimpleNtuple.cc ******                                                                                                               
